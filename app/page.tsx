...
const posts = [
  { id:1, category:'창업', title:'매출이 아니라 재구매율을 보기 시작하자 사업이 달라졌다', excerpt:'첫 구매를 만드는 것보다 두 번째 구매를 설계하는 일이 훨씬 중요했습니다. 고객 인터뷰 30번 끝에 찾은 세 가지 전환점을 공유합니다.', author:'김서준', role:'커머스 브랜드 대표', initials:'김', time:'2시간 전', likes:128, comments:24, views:'2.1k', featured:true, color:'#ffe4d3' },
  { id:2, category:'마케팅', title:'광고비 0원으로 첫 고객 100명을 모은 방법', excerpt:'채널을 늘리기 전에 고객이 이미 모여 있는 한 곳을 깊게 파고들었습니다.', author:'이하은', role:'그로스 마케터', initials:'이', time:'4시간 전', likes:86, comments:17, views:'1.4k', color:'#f2e8d5' },
  { id:3, category:'AI·테크', title:'팀의 반복 업무 40%를 줄인 AI 자동화 설계도', excerpt:'도구보다 먼저 정리해야 할 업무 흐름과 실패했던 자동화 사례까지 공개합니다.', author:'박도윤', role:'AI 프로덕트 빌더', initials:'박', time:'어제', likes:203, comments:31, views:'3.8k', color:'#eceae4' },
  { id:4, category:'브랜딩', title:'작은 브랜드가 가격 경쟁에서 빠져나오는 법', excerpt:'예쁜 로고보다 고객이 우리를 기억할 한 문장이 먼저였습니다.', author:'최유진', role:'브랜드 디렉터', initials:'최', time:'어제', likes:74, comments:12, views:'980', color:'#ffd6bd' },
  { id:5, category:'커리어', title:'퇴사 전 90일, 독립을 준비하며 만든 체크리스트', excerpt:'막연한 자신감 대신 현금흐름과 고객 파이프라인을 숫자로 점검했습니다.', author:'오민재', role:'1인 기업 운영자', initials:'오', time:'2일 전', likes:156, comments:28, views:'2.7k', color:'#f6ecd9' },
];
const people = [
  {name:'정지우', role:'SaaS 창업가', init:'정', color:'#1a1a1a'}, {name:'한소연', role:'콘텐츠 전략가', init:'한', color:'#ff6b2c'}, {name:'윤태호', role:'VC 심사역', init:'윤', color:'#8a5a3b'}
];
