  ...
  return <>
    ...
    <main>
      <section className="pgHero"><div className="wrap pgHeroInner">
        <div>
          <span className="eyebrow">SUCCESS INSIDE PROGRAMS</span>
      ...
      <section className="wrap pgSection">
        <div className="pgHead"><small>MENTORS</small><h2>먼저 가본 실무자와 함께합니다</h2><p>성공인사이드에서 경험을 나누는 멤버가 직접 과정을 이끕니다.</p></div>
      ...
      {showLive && <section className="wrap pgSection" id="live">
        <div className="pgHead"><small>LIVE COHORT</small><h2>정기 과정</h2><p>기수제로 함께 진행합니다. 매주 과제와 피드백으로 결과물을 완성합니다.</p></div>
      ...
      {showVod && <section className="wrap pgSection" id="vod">
        <div className="pgHead"><small>ON DEMAND</small><h2>VOD 과정</h2><p>원하는 시점에 바로 시작합니다. 강사 이력과 학습 내용을 확인하고 선택하세요.</p></div>
